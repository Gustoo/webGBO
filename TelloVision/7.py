...
cv2.createTrackbar("HUE Min","HSV",143,179,empty)
cv2.createTrackbar("HUE Max","HSV",179,179,empty)
cv2.createTrackbar("SAT Min","HSV",62,255,empty)
cv2.createTrackbar("SAT Max","HSV",255,255,empty)
cv2.createTrackbar("VALUE Min","HSV",107,255,empty)
...
while True:
   ...
   # SEND VELOCITY VALUES TO TELLO
    ...
    stack =cv2.cvtColor(stack,cv2.COLOR_RGB2BGR)
